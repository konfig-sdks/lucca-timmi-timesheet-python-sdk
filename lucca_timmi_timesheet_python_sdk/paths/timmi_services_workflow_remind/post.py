...
from lucca_timmi_timesheet_python_sdk.model.workflow_send_reminder_email_request import WorkflowSendReminderEmailRequest as WorkflowSendReminderEmailRequestSchema
from lucca_timmi_timesheet_python_sdk.model.workflow_send_reminder_email_request_timesheets import WorkflowSendReminderEmailRequestTimesheets as WorkflowSendReminderEmailRequestTimesheetsSchema

from lucca_timmi_timesheet_python_sdk.type.workflow_send_reminder_email_request import WorkflowSendReminderEmailRequest
from lucca_timmi_timesheet_python_sdk.type.workflow_send_reminder_email_request_timesheets import WorkflowSendReminderEmailRequestTimesheets
...
from lucca_timmi_timesheet_python_sdk.pydantic.workflow_send_reminder_email_request import WorkflowSendReminderEmailRequest as WorkflowSendReminderEmailRequestPydantic
from lucca_timmi_timesheet_python_sdk.pydantic.workflow_send_reminder_email_request_timesheets import WorkflowSendReminderEmailRequestTimesheets as WorkflowSendReminderEmailRequestTimesheetsPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = WorkflowSendReminderEmailRequestSchema


request_body_workflow_send_reminder_email_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _send_reminder_email_mapped_args(
        self,
        timesheets: typing.Optional[WorkflowSendReminderEmailRequestTimesheets] = None,
    ...
    async def _asend_reminder_email_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timmi/services/workflow/remind',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_workflow_send_reminder_email_request.serialize(body, content_type)

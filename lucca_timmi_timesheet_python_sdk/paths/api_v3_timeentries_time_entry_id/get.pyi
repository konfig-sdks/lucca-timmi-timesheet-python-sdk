...
from lucca_timmi_timesheet_python_sdk.model.time_entries_get_by_id_response import TimeEntriesGetByIdResponse as TimeEntriesGetByIdResponseSchema
...
from lucca_timmi_timesheet_python_sdk.type.time_entries_get_by_id_response import TimeEntriesGetByIdResponse

from ...api_client import Dictionary
from lucca_timmi_timesheet_python_sdk.pydantic.time_entries_get_by_id_response import TimeEntriesGetByIdResponse as TimeEntriesGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TimeEntriesGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeEntriesGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeEntriesGetByIdResponsePydantic:
        raw_response = await self.raw.aget_by_id(
            time_entry_id=time_entry_id,
            **kwargs,
        )
        if validate:
            return TimeEntriesGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeEntriesGetByIdResponsePydantic, raw_response.body)

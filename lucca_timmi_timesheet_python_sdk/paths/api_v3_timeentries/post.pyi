...
from lucca_timmi_timesheet_python_sdk.model.time_entries_create_multiple_request import TimeEntriesCreateMultipleRequest as TimeEntriesCreateMultipleRequestSchema
from lucca_timmi_timesheet_python_sdk.model.time_entries_create_multiple_response import TimeEntriesCreateMultipleResponse as TimeEntriesCreateMultipleResponseSchema
...
from lucca_timmi_timesheet_python_sdk.type.time_entries_create_multiple_response import TimeEntriesCreateMultipleResponse
from lucca_timmi_timesheet_python_sdk.type.time_entries_create_multiple_request import TimeEntriesCreateMultipleRequest
from lucca_timmi_timesheet_python_sdk.type.axis_section import AxisSection

from ...api_client import Dictionary
from lucca_timmi_timesheet_python_sdk.pydantic.time_entries_create_multiple_request import TimeEntriesCreateMultipleRequest as TimeEntriesCreateMultipleRequestPydantic
from lucca_timmi_timesheet_python_sdk.pydantic.time_entries_create_multiple_response import TimeEntriesCreateMultipleResponse as TimeEntriesCreateMultipleResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TimeEntriesCreateMultipleRequestSchema


request_body_time_entries_create_multiple_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = TimeEntriesCreateMultipleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeEntriesCreateMultipleResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_multiple_mapped_args(
        self,
        ...
        body: typing.Optional[TimeEntriesCreateMultipleRequest] = None,
    ...
    async def _acreate_multiple_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_time_entries_create_multiple_request.serialize(body, content_type)
...
class CreateMultipleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_multiple(
        self,
        id: typing.Optional[int] = None,
        starts_at: typing.Optional[datetime] = None,
        duration: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_multiple_mapped_args(
            body=body,
            id=id,
            starts_at=starts_at,
            duration=duration,
        ...
        return await self._acreate_multiple_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_multiple(
        ...
        return self._create_multiple_oapg(
            body=args.body,
        )

class CreateMultiple(BaseApi):
    ...
    async def acreate_multiple(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeEntriesCreateMultipleResponsePydantic:
        raw_response = await self.raw.acreate_multiple(
            body=body,
            id=id,
            starts_at=starts_at,
            duration=duration,
        ...
        if validate:
            return TimeEntriesCreateMultipleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeEntriesCreateMultipleResponsePydantic, raw_response.body)
    ...
    def create_multiple(
        ...
        raw_response = self.raw.create_multiple(
            body=body,
            id=id,
            starts_at=starts_at,
            duration=duration,

...
from lucca_timmi_timesheet_python_sdk.exceptions_base import ApiValueError
from lucca_timmi_timesheet_python_sdk.exceptions import ClientConfigurationError
...
conf = lucca_timmi_timesheet_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://example.ilucca.net" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if authorization:
            self.api_key['Authorization'] = authorization
        else:
            raise ClientConfigurationError('API Key "Authorization" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("lucca_timmi_timesheet_python_sdk")
